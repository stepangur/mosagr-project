...
export default function Requirements() {
  ...
  return (
    <>
      <Seo
        title="Требования к буклету АГР по Постановлению 284-ПП — Москомархитектура (МКА)"
        description="Актуальные требования Москомархитектуры (МКА) к буклету АГР по Постановлению Правительства Москвы №284-ПП. Порядок подачи в Архитектурную комиссию, ТЭПы, Свидетельство об утверждении АГР, 3D-модели ВПМ и НПМ, IFC с апреля 2026."
        keywords="требования АГР 284-ПП, Постановление 284-ПП Москва АГР, Москомархитектура МКА требования, ТЭПы в буклете АГР, Архитектурная комиссия МКА, свидетельство об утверждении АГР, состав буклета АГР, ВПМ НПМ 3D модель Москва, IFC АГР 2026, FBX модель Москомархитектура"
        path="/requirements"
      ...
      <div className="bg-white py-14 border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-display font-bold text-slate-900 mb-5">
            Требования к буклету АГР в Москве по Постановлению №284-ПП
          </h2>
          <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-4 text-sm">
            <p>
              Разработка буклета АГР (архитектурно-градостроительного облика) в Москве регламентируется Постановлением Правительства Москвы <strong>№284-ПП от 30.04.2013</strong> (ред. от 01.10.2025) и Приказом <strong>Москомархитектуры (МКА) №282</strong> от 17.10.2025. Буклет является основным документом для получения <strong>Свидетельства об утверждении АГР</strong>.
            </p>
            <p>
              В состав буклета АГР входят обязательные разделы: пояснительная записка с <strong>ТЭПами</strong> объекта, чертежи фасадов, 3D-визуализация, фотофиксация существующего состояния (<strong>обследование здания</strong> со склерометром при реконструкции), фотомонтаж в существующую застройку, а также трёхмерные модели НПМ и ВПМ для ЦИМ АГР.
            </p>
            <p>
              Архитектурная комиссия <strong>МКА</strong> рассматривает материалы в два этапа: предварительное рассмотрение концепции (без ВПМ) и рабочее рассмотрение полного буклета. После одобрения выдаётся официальное <strong>Свидетельство об утверждении АГР</strong> — документ, необходимый для получения разрешения на строительство.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-primary rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 text-center md:text-left flex flex-col md:flex-row items-center gap-8 justify-between">
              <div>
                <h3 className="text-2xl font-bold font-display mb-2">Готовы получить Свидетельство об утверждении АГР?</h3>
