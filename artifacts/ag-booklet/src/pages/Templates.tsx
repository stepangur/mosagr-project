...
export default function Templates() {
  ...
  return (
    <>
      <Seo
        title="Шаблоны и образцы буклета АГР — скачать бесплатно | МКА Москва"
        description="Бесплатные шаблоны буклета АГР по требованиям Москомархитектуры (МКА). Задание на проектирование АГР, шаблоны PPTX для концепций, нормативные документы, 3D-модели НПМ и ВПМ (IFC, FBX), плагины Blender."
        keywords="шаблон буклета АГР скачать, задание на проектирование АГР МКА, образец АГР Москомархитектура, шаблон презентации АГР PPTX, 3D модель НПМ ВПМ скачать IFC, пример АГР обследование здания, плагин Blender FBX IFC, нормативы МКА 284-ПП"
        path="/templates"
      ...
      <section className="py-14 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-display font-bold text-slate-900 mb-5">
            Шаблоны и образцы буклета АГР по требованиям МКА
          </h2>
          <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-4 text-sm">
            <p>
              В библиотеке представлены официальные материалы <strong>Москомархитектуры (МКА)</strong> и авторские разработки для подготовки проектной документации АГР. Все файлы соответствуют актуальным требованиям на 2025–2026 год.
            </p>
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <strong>Шаблоны презентаций PPTX</strong> — задание на проектирование АГР по требованиям МКА: шаблоны концепции АГР с НПМ, буклета с ВПМ, концепции благоустройства, АХК информационных конструкций, крышных и медиафасадных рекламных конструкций.
              </li>
              <li>
                <strong>Нормативные документы (PDF, XLSX)</strong> — регламенты Москомархитектуры: требования к составу и форматам проектных материалов, инструкция по предоставлению исходных данных по НПМ и ВПМ (3D-модели) для ЦИМ АГР.
              </li>
              <li>
                <strong>3D-модели (IFC, FBX)</strong> — примеры высокополигональных (ВПМ) и низкополигональных (НПМ) моделей для обследования здания и цифрового двойника Москвы. Используйте кнопку «3D» для онлайн-просмотра IFC-модели прямо в браузере.
              </li>
              <li>
                <strong>Плагины для Blender</strong> — инструменты для подготовки моделей к требованиям Москомархитектуры (уменьшение полигонажа, UV-развёртка, экспорт FBX/IFC).
              </li>
            </ul>
            <p>
              Все шаблоны распространяются бесплатно. Если вам нужна помощь с разработкой буклета АГР «под ключ» — оставьте заявку, рассчитаем стоимость и сроки.
            </p>
          </div>
        </div>
      </section>
