...
export default function Home() {
  ...
  return (
    <>
      <Seo
        title="Разработка АГР в Москве — буклет для Москомархитектуры | МосАГРПроект"
        description={s("seo.description", "Разработка буклета АГР в Москве и МО — согласование в Москомархитектуре (МКА). Свидетельство об утверждении АГР под ключ, от 10 рабочих дней, 95% с первого раза. Более 500 объектов. ООО «Минерал».")}
        keywords={s("seo.keywords", "разработка АГР Москва, буклет АГР Москомархитектура, МКА согласование, свидетельство об утверждении АГР, ТЭПы АГР, архитектурно-градостроительный облик Москва, АГР под ключ, согласование фасада Москва, разработка АГР цена, АГР МО")}
        path="/"
        structuredData={[
          {
      ...
      <section className="relative overflow-hidden pt-20 pb-16 lg:pt-28 lg:pb-20">
        <div className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none">
          <img
            ...
            alt="Чертёж архитектурно-градостроительного облика (АГР) Москва"
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/20">
              ...
              <img
                ...
                alt="Пример АГР — разработка буклета архитектурно-градостроительного облика здания в Москве"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-slate-600 text-lg">
              Архитектурно-градостроительный облик (АГР) — обязательный документ для согласования фасадных решений, рекламных конструкций и благоустройства в Москве. Рассматривается на заседании Архитектурной комиссии Москомархитектуры (МКА). По итогам согласования выдаётся <strong>Свидетельство об утверждении АГР</strong>. В состав буклета входят ТЭПы объекта, концепция фасада, фотомонтаж и трёхмерные модели.
            </p>
          </div>
