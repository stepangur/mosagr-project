...
export default function Services() {
  ...
  return (
    <>
      ...
      <Seo
        title="Услуги по разработке буклета АГР — цены и тарифы"
        description="Профессиональная разработка буклета АГР в Москве. Консультация по требованиям Москомархитектуры, разработка полного альбома АГР, сопровождение до получения Свидетельства. Цены от 20 000 ₽."
        keywords="разработка буклета АГР цена, услуги АГР Москва, стоимость согласования АГР, буклет АГО под ключ, Москомархитектура"
        path="/services"
      ...
      <section className="py-16 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-4 text-sm">
            <p>
              <strong>Архитектурно-градостроительный облик (АГР)</strong> — обязательный документ для согласования фасадных решений, благоустройства, рекламных и информационных конструкций в Москве. Буклет АГР рассматривается на заседании Архитектурной комиссии Москомархитектуры и является основанием для выдачи Свидетельства об утверждении АГР.
            </p>
            <p>
              МосАГРПроект специализируется на разработке проектных материалов по требованиям Москомархитектуры (ДГП). Мы работаем в соответствии с актуальными регламентами: Приказ №282 от 17.10.2025 (ред. №338 от 26.11.2025) и требованиями к составу и форматам проектных материалов.
            </p>
            <p>
              В наш стандартный пакет «Буклет АГР» входят: разработка всех обязательных разделов, архитектурная 3D-визуализация фасадов и окружения, фотофиксация с натуры, фотомонтаж, а также формирование итогового альбома в PDF. При необходимости готовим НПМ и ВПМ трёхмерные модели для ЦИМ АГР в соответствии с Распоряжением №64-16-429/25/1736 от 22.08.2025.
            </p>
            <p>
              Пакет «Полный» включает не только разработку буклета, но и подачу материалов через портал Мос.ру, взаимодействие с экспертами МКА на этапе предварительного и рабочего рассмотрения, а также гарантированное получение Свидетельства об утверждении АГР.
            </p>
          </div>
        </div>
      </section>
